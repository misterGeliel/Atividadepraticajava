...
import br.com.fujideia.iesp.tecback.classe.DTO.CinematografiaDTO;
...
public class CinematografiaService {
    ...
    public Cinematografia criarCinematografia(CinematografiaDTO cinematografia) {
        return cinematografiaRepository.save(cinematografia);
    }

    public Optional<Cinematografia> atualizarCinematografia(Long id, CinematografiaDTO cinematografia) {
