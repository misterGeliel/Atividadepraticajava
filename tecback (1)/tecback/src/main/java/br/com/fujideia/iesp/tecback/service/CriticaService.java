...
import br.com.fujideia.iesp.tecback.classe.DTO.CriticaDTO;
...
public class CriticaService {
    ...
    public Critica criarCritica(CriticaDTO critica) {
        return criticaRepository.save(critica);
    }

    public Optional<Critica> atualizarCritica(Long id, CriticaDTO critica) {
